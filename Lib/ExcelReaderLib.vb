...
' First column is Element/MooduliNimi (used for folder naming)
...
Public Module ExcelReaderLib
    ...
    ''' Supports both Element (new) and MooduliNimi (legacy) column names.
    ''' </summary>
    ...
    Public Function ReadVariantTable(excelPath As String, Optional sheetName As String = "") As List(Of ElementConfig)
        ...
        Try
            ...
            If rowCount < 2 OrElse colCount < 1 Then
                Throw New Exception("Excel table must have at least 2 rows (header + data) and 1 column (Element)")
            End If
            ...
            For row As Integer = 2 To rowCount
                ...
                ' First column is Element/MooduliNimi (stored as ElementName)
