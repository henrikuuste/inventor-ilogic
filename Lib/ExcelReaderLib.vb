...
'
' Excel Table Format:
' | MooduliNimi | Param1 | Param2 | ... |
' |-------------|--------|--------|-----|
' | Moodul-A    | 100    | 200    | ... |
' | Moodul-B    | 150    | 250    | ... |
'
' First row is headers (parameter names)
' First column is MooduliNimi (used for folder naming)
    ...
    Public Function ReadVariantTable(excelPath As String, Optional sheetName As String = "") As List(Of ReleaseConfig)
        ...
        Try
            ...
            If rowCount < 2 OrElse colCount < 1 Then
                Throw New Exception("Excel table must have at least 2 rows (header + data) and 1 column (MooduliNimi)")
            End If
            ...
            For row As Integer = 2 To rowCount
                ...
                ' First column is MooduliNimi (stored as ConfigName)
