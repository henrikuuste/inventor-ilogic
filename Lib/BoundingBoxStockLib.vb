...
Public Module BoundingBoxStockLib
    ...
    Public Function BuildRuleText() As String
        ...
        sb.AppendLine("AddVbFile ""Lib/CustomPropertiesLib.vb""")
        sb.AppendLine("")
        ...
        sb.AppendLine("")
        sb.AppendLine("    ' Use centralized dimension property validation/fix logic")
        sb.AppendLine("    CustomPropertiesLib.ValidateAndFixDimensionProperties(partDoc, thicknessVal, widthVal, lengthVal)")
